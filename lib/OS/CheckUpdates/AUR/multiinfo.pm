...
OS::CheckUpdates::AUR::multiinfo - aur interface
...
=head2 multiinfo_spliced_by($, @)

 function for get(), split package list by... and run multiinfo()

=head2 multiinfo(@)

 check, parse and download data from arguments passed to function 

=head2 rpc_uri_multiinfo(@)

 generate url for aurjson rpc
